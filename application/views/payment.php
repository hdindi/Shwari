    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
		...
		<div class="span13 well" style="margin-top: 200px; margin-left: 100px; width:1000px;">
            ...
            <tr>
                <td><form name="frmactive" id="frmactive" method="post" autocomplete="off" action="<?php echo base_url()?>reception/lab_cost" onSubmit="return Blank_TextField_Validator()">
                   <table class="table">
...
else if(frmactive.MpesaCode.value!=""&&frmactive.cpay.value==""){
	alert("Please enter you Mpesa Amount");
	return false;
...
else if(frmactive.cash.value !=frmactive.total.value)
{
	if(frmactive.cpay.value==""){
		alert("Please check that you have put in the correct amount of money");
		return false;
		}
	if(frmactive.cpay!=""){
	  var total=0;
