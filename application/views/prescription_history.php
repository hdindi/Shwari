...
<body>
    ...
    <ul class="nav">
     ...
     <li><a href='<?php echo site_url('phamarcy/add_medicine')?>'><img src="<?php echo base_url()?>assets/img/medical_pot.png" title="Add medicines"></a></li>
         ...
         <li><a href='<?php echo site_url('phamarcy/add_nonemed')?>'>Add New</a></li>  
	</ul>
		</div>	
	</div>
	<div class="container-fluid">
      ...
      <tr class="success">
       ...
       <tr>
        <td><?php echo $prescribed['VisitDate'];?></td>
        <td><?php echo $prescribed['fname']." ".$prescribed['lname']." ".$prescribed['lname'];?></td>
        <td><?php echo $prescribed['medname'];?></td>
        <td><?php echo $prescribed['docid'];?></td>
        <td><?php echo $prescribed['duration']?></td>
        <td><?php echo $prescribed['dosage'];?></td>
        <td><?php echo $prescribed['remarks'];?></td>
