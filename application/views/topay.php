    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
		...
		<div class="span9 well" style="margin-top: 200px; margin-left: 100px; width:1000px;">
            ...
            <tr>
                <td><form name="frmactive" id="frmactive" method="post" autocomplete="off" action="<?php echo base_url()?>reception/walkin_cost" onSubmit="return Blank_TextField_Validator()">
                   <table class="table">
                        <input type="hidden" name="patientid" value="<?php echo $this->uri->segment(3)?>"/>
                       
                       
         
                    <?php foreach($topay as $rows){?>
                    <tr>
                      <!--<td align="center"><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $rows['id']?>" ></td>!-->
                       <?php echo $rows['patientname']?>
        ...
        <tr>
              ...
              <td>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input id="total" type="number" value="<?php echo $rows['total']?>" disabled>
                      <?php } ?>
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="number" name="cpay" id="cpay" min="0" value=""/>
                  </div>
                </div>
              </td>
              <td>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" id="MpesaCode" name="mpesa"/>
                  </div>
                </div>
              </td>
            </tr>
...
var reg = new RegExp("[A-Z](?=[A-Z][0-9][0-9][A-Z][A-Z][0-9][0-9][0-9])");
if (!reg.test(q)){
//alert("string contai");
