...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <a class="brand" href='<?php echo site_url('labprofile') ?>' title="Home" ><img src="<?php echo base_url()?>assets/img/shwari.png" alt="Home"></a>
    ...
    <ul class="nav">
     ...
     <li><a href='<?php echo site_url('lab/tests')?>'><img src="<?php echo base_url()?>assets/img/medical_pot.png" title="Add medicines"></a></li>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list" id="load">
              ...
              <h3>Order</h3>
              <div>
				<li><a href="<?php echo site_url('lab_profile/order')?>">Order Supplies</a></li>             
              </div>
            <h3>My Store</h3>
            <div>
            <li><a href="<?php echo site_url('lab_profile/bin')?>">Order History</a></li>
            </div>
                 </div>
                 </li>
                 </ul>
