...
<body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
     ...
     <ul class="nav">
        ...
        <li><a href='<?php echo site_url('admin/reports')?>' title="css menus">Consultation Report</a></li>
        <li><a href='<?php echo site_url('admin/lab')?>' title="css menus">Lab Report</a></li>
        <li><a href='<?php echo site_url('admin/pharm')?>' title="css menus">Pharmacy Report</a></li>
        <li><a href='<?php echo site_url('admin/pharm')?>' title="css menus">Walk In Report</a></li>
