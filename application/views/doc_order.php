...
<link rel="stylesheet" href="/resources/demos/style.css" />
  ...
  heightStyle: "content"
   ...
   <script>
  $(function() {
  $( "#datepicker" ).datepicker({ minDate: "-1Y", maxDate: 100});
  });
  </script>
    <script>
    $(function() {
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list" id="load">
              ...
              <h3>Order</h3>
              <div>
				<li><a href="<?php echo site_url('doc_profile/order')?>">Order Supplies</a></li>             
              </div>
            <h3>My Store</h3>
            <div>
            <li><a href="<?php echo site_url('doc_profile/bin')?>">Order History</a></li>
            </div>
                 </div>
                 </li>
                 </ul>
