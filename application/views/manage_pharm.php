<?php if($this->session->userdata('id')){
    ...
    // redirect('/adminhome');
        ...
        <?php }?><?php 
                  ...
                  <table>
                   <form action="<?php echo base_url()?>management/pharmbymonth" method="post">
                 ...
                 <option value="12">December</option>
                  ...
                  <input type="submit" name="search" value="Search">
                   ...
                   <form action="<?php echo base_url()?>management/pharmbydate" method="post">
                  <tr>Date<input type="date" id="datepicker" name="Date" required value="<?php echo $date?>"/></tr>
                  <input type="submit" name="search" value="Search">
                  </form>
                  </table>
