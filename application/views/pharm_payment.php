    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
		...
		<div class="span9 well" style="margin-top: 200px; margin-left: 100px; width:1000px;">
            ...
            <tr>
                <td><form name="frmactive" id="frmactive" method="post" autocomplete="off" action="<?php echo base_url()?>reception/pharm_cost" onSubmit="return Blank_TextField_Validator()">
                   <table class="table">
                        <input type="hidden" name="visitid" value="<?php echo $this->uri->segment(3)?>"/>
                        <input type="hidden" name="faculty" value="Pharm"/>
        ...
        <tr>
              ...
              <td>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input id="total" type="number" value="<?php echo $rows['cost']?>" disabled>
                      <?php } ?>
                  </div>
                </div>
              </td>
