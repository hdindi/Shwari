...
class Pats extends CI_Controller {
	...
	{
		$this->load->view('purse.php',$output);	
	}
	...
	function patient_management()
	{
			...
			$crud->columns('fname','sname','lname','dob','residence');
			...
			$crud->unset_delete();
			$crud->unset_add();
			$crud->edit_fields('fname','sname','lname','dob','residence');
